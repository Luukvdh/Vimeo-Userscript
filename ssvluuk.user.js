...
var page = $.ajax({
     ...
     //$('table > tbody  > tr').each(function(sy) {console.log(this); if(!markbool) {if($(this).find('td').eq(7).text().includes("0")) {console.log("ja hoor, een lege!, namelijk: "+sy); this.remove();};};});



    //setTimeout(function() {titles[0].children[0].click();},1000);
